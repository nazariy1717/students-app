                    ...
                    <div className="schedule-table">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="checkbox">
                                        <input type="checkbox" name="label" id="label1" checked/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="checkbox">
                                        <input type="checkbox" name="label" id="label2" checked/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="checkbox">
                                        <input type="checkbox" name="label" id="label4" checked/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="checkbox">
                                        <input type="checkbox" name="label" id="label6" checked/>
